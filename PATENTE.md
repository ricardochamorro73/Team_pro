...
| Patente 2 - EP3103099A4 - Device management system -  https://patents.google.com/patent/EP3103099A4/en?oq=EP3103099A4 | Prioridad: 07/02/2014  07/02/2014 – Smartline Machinery Pty Ltd – Retirada | Gestionar y rastrear dispositivos médicos durante su uso, limpieza y procesamiento. | Identificación y gestión digital de dispositivos mediante información asociada a cada equipo. | Requiere dispositivos identificables, un sistema de gestión y registro de las operaciones realizadas sobre ellos. | Depende de la interacción manual para registrar cada fase de procesamiento/mantenimiento, sin integrarse a sistemas de alerta temprana o tecnovigilancia institucional. |
